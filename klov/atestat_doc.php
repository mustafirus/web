...
//			    display : block;
		...
		<div>
			...
			<p class="Standard">&nbsp;</p>
			<p class="Standard">&nbsp;</p>
			<p class="P2">АТЕСТАТ НА НАСІННЯ № <?php printf("%03d", $idd); ?></p>
			<p class="Standard">&nbsp;</p>
			<p class="Standard">&nbsp;</p>
			<p class="Standard">&nbsp;</p>
			<p class="Standard">&nbsp;</p>
			<p class="Standard">Категорія насіння ___________<span class="T2">елітне</span>________________________________________</p>
			<p class="Standard"><span class="T1">Наукове дослідне (елітно-насінницьке господарство) </p>
			
			<p class="P2"><?php echo $props->org ?> <br/>
			         Адреса: <?php echo $props->zip ?> <?php echo $props->city ?>
			</p>
			<p class="Standard"><span class="T1">1. Культура _______________________</span><span class="T2"><?php echo $sert->cultura ?></span><span class="T1">________________________________________________</span></p>
			<p class="Standard"><span class="T1">2. Сорт ___________________________</span><span class="T2"><?php echo $sert->sort ?></span><span class="T1">_________________________________________</span></p>
			<p class="Standard"><span class="T1">3. Етап насінництва _______________</span><span class="T2">еліта</span><span class="T1">_____________________________________________</span></p>
			...
			<p class="Standard">панцирність соняшника __-__%, ксенійність кукурудзи (зерен на  качанів) ______-______</p>
			<p class="Standard">10. Склад сортової домішки (назва,%)
			...
			<p class="Standard">12. Засміченість посіву: карантинними бур’янами (назва, % за актом
				...
				об’єктами (назва,%) ________-_________, не виявлено отруйними, злісними та
...
<!--				<col width="2.64cm" />
				...
				<col width="139.0px" />
				<col width="78.0px" />
-->				<tbody><tr class="Table11" height="70">
					<td rowspan="2" class="Table1_A1"><p class="Standard">Насіння основної &nbsp;культури , %</p></td>
					<td rowspan="2" class="Table1_A1"><p class="Standard">Відхід, ,% </p></td>
					<td colspan="3" class="Table1_A1"><p class="Standard">В т.ч. насіння </p></td>
					<td rowspan="2" class="Table1_A1"><p class="Standard">Вологість, %</p></td>
					<td rowspan="2" class="Table1_A1"><p class="Standard">Енергія проростанн, % </p></td>
					<td rowspan="2" class="Table1_A1"><p class="Standard">Схожість, %</p></td>
					<td rowspan="2" class="Table1_A1"><p class="Standard">Маса 1000 насінин, г</p></td>
					<td colspan="2" class="Table1_L1"><p class="Standard">Зараження <br/> хворобами <br/> та шкідниками</p></td>
				</tr>
				<tr class="Table12" height="240">
					<td rowspan="1" class="Table1_A1"><p class="Standard">Інших культурних рослин, шт./кг </p></td>
					<td rowspan="1" class="Table1_A1"><p class="Standard">Всього шт../кг Інших рослин</p></td>
					<td rowspan="1" class="Table1_A1"><p class="Standard">Бур’янів</p></td>
					<td rowspan="1" class="Table1_A1"><p class="Standard">назва</p></td>
					<td rowspan="1" class="Table1_M2"><p class="Standard">% або ступінь зараження</p></td>
				</tr>
				<tr class="Table14">
			...
			<p class="P2"><?php echo $props->org ?></p>
			<p class="Standard">&nbsp;</p>
